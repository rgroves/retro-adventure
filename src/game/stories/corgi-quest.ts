    ...
    items: new Map([
      [
        ...
        new Item({
          ...
          sceneDescFragment: " A gigantic mushroom sits here, glowing faintly.",
          isTakeable: false,
          takenPointValue: 0,
          takenMessage: "",
          isExaminable: true,
    ...
    items: new Map([
      [
        ...
        new Item({
          id: "leaf",
          name: "Giggling Leaf",
          sceneDescFragment: " A giggling leaf flutters in front of you here.",
          isTakeable: true,
          takenPointValue: 15,
          takenMessage: "You take the leaf. It keeps giggling.",
          isExaminable: true,
          examinePointValue: 5,
          examineMessage: "The leaf’s laughter is high-pitched and infectious.",
          qty: 1,
        }),
      ],
    ]),
